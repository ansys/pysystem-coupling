...
_COMMANDREQUEST_ARGUMENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="ansys.api.systemcoupling.v0.CommandRequest.Argument.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="val",
            full_name="ansys.api.systemcoupling.v0.CommandRequest.Argument.val",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_COMMANDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="command",
            full_name="ansys.api.systemcoupling.v0.CommandRequest.command",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="args",
            full_name="ansys.api.systemcoupling.v0.CommandRequest.args",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_COMMANDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="result",
            full_name="ansys.api.systemcoupling.v0.CommandResponse.result",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
