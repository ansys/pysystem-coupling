...
Settings objects provide a natural way to access and modify System Coupling data model settings and
issue commands with a hierarchy of objects.

**TODO** The following Fluent doc may be adaptable to System Coupling as the latter uses a
stripped down/slightly diverged form of the Fluent infrastructure. Obviously specific examples
need adjusting to SyC examples.
