...
class system_coupling(Group):
    ...
    child_names = \
        ['activate_hidden', 'library', 'coupling_participant',
         'analysis_control', 'coupling_interface', 'solution_control',
         'output_control']
    ...
    class library(Group):
        ...
        syc_name = "Library"
        child_names = \
            ['expression', 'expression_function', 'reference_frame',
             'instancing']
        ...
        class reference_frame(NamedObject):
            ...
            class child_object_type(Group):
                ...
                property_names_types = \
                    [('option', 'Option', 'String'),
                     ('parent_reference_frame', 'ParentReferenceFrame',
                      'String'),
            ...
            class child_object_type(Group):
                ...
                property_names_types = \
                    [('reference_frame', 'ReferenceFrame', 'String'),
                     ('instances_in_full_circle', 'InstancesInFullCircle',
                      'Integer'),
                     ('instances_for_mapping', 'InstancesForMapping',
                      'Integer')]
    ...
    class coupling_participant(NamedObject):
        ...
        class child_object_type(Group):
            ...
            syc_name = "child_object_type"
            child_names = \
                ['variable', 'region', 'update_control', 'fmu_parameter',
                 'execution_control', 'external_data_file']
                ...
                class child_object_type(Group):
                    ...
                    property_names_types = \
                        [('quantity_type', 'QuantityType', 'String'),
                         ...
                         ('integer_initial_value', 'IntegerInitialValue',
                          'Integer'),
                         ('logical_initial_value', 'LogicalInitialValue',
                          'Boolean'),
                ...
                property_names_types = \
                    [('option', 'Option', 'String'),
                     ...
                     ('additional_restart_input_file',
                      'AdditionalRestartInputFile', 'String'),
            ...
            property_names_types = \
                [('participant_type', 'ParticipantType', 'String'),
                 ('participant_display_name', 'ParticipantDisplayName',
                  'String'),
                 ('display_name', 'DisplayName', 'String'),
                 ('participant_file_loaded', 'ParticipantFileLoaded',
                  'String'),
                 ('logging_on', 'LoggingOn', 'Boolean'),
                 ('participant_analysis_type', 'ParticipantAnalysisType',
                  'String'),
    ...
    class analysis_control(Group):
        ...
        child_names = \
            ['global_stabilization', 'apip', 'unmapped_value_options']
        ...
        class global_stabilization(Group):
            ...
            property_names_types = \
                [('option', 'Option', 'String'),
                 ...
                 ('initial_relaxation_factor', 'InitialRelaxationFactor',
                  'Real'),
                 ('maximum_retained_time_steps', 'MaximumRetainedTimeSteps',
                  'Integer'),
                 ('maximum_retained_iterations', 'MaximumRetainedIterations',
                  'Integer'),
        ...
        class unmapped_value_options(Group):
            ...
            property_names_types = \
                [('matrix_verbosity', 'MatrixVerbosity', 'Integer'),
                 ...
                 ('solver_relative_tolerance', 'SolverRelativeTolerance',
                  'Real'),
                 ('solver_max_iterations', 'SolverMaxIterations', 'Integer'),
                 ('solver_max_search_directions', 'SolverMaxSearchDirections',
                  'Integer'),
                 ...
                 ('rbf_colinearity_tolerance', 'RbfColinearityTolerance',
                  'Real')]
        ...
        property_names_types = \
            [('analysis_type', 'AnalysisType', 'String'),
             ...
             ('allow_simultaneous_update', 'AllowSimultaneousUpdate',
              'Boolean'),
             ('simultaneous_participants', 'SimultaneousParticipants',
              'String'),
             ('partitioning_algorithm', 'PartitioningAlgorithm', 'String'),
             ('allow_iterations_only_mode', 'AllowIterationsOnlyMode',
              'Boolean'),
             ('target_initialization_option', 'TargetInitializationOption',
              'String'),
             ('fluent_region_update_at_step', 'FluentRegionUpdateAtStep',
              'Boolean'),
             ('mesh_import_on_initialization', 'MeshImportOnInitialization',
              'Boolean'),
             ...
             ('variable_to_expression_transfer',
              'VariableToExpressionTransfer', 'Boolean'),
             ...
             ('solve_incremental_displacement_first',
              'SolveIncrementalDisplacementFirst', 'Boolean'),
    ...
    class coupling_interface(NamedObject):
        ...
        class child_object_type(Group):
            ...
            syc_name = "child_object_type"
            child_names = \
                ['side', 'data_transfer', 'mapping_control']
            ...
            class side(NamedObject):
                ...
                class child_object_type(Group):
                    ...
                    syc_name = "child_object_type"
                    property_names_types = \
                        [('coupling_participant', 'CouplingParticipant',
                          'String'),
                ...
                class child_object_type(Group):
                        ...
                        property_names_types = \
                            [('option', 'Option', 'String'),
                             ('couple_with_global_stabilization',
                              'CoupleWithGlobalStabilization', 'Boolean'),
                             ('initial_iterations', 'InitialIterations',
                              'Integer'),
                             ('initial_relaxation_factor',
                              'InitialRelaxationFactor', 'Real'),
                             ('maximum_retained_time_steps',
                              'MaximumRetainedTimeSteps', 'Integer'),
                             ('maximum_retained_iterations',
                              'MaximumRetainedIterations', 'Integer'),
                             ...
                             ('time_step_initialization_option',
                              'TimeStepInitializationOption', 'String')]
                    ...
                    property_names_types = \
                        [('display_name', 'DisplayName', 'String'),
                         ...
                         ('unmapped_value_option', 'UnmappedValueOption',
                          'String'),
                         ('time_step_initialization_option',
                          'TimeStepInitializationOption', 'String')]
            ...
            class mapping_control(Group):
                ...
                property_names_types = \
                    [('stop_if_poor_intersection', 'StopIfPoorIntersection',
                      'Boolean'),
                     ('poor_intersection_threshold',
                      'PoorIntersectionThreshold', 'Real'),
                     ('face_alignment', 'FaceAlignment', 'String'),
                     ('absolute_gap_tolerance', 'AbsoluteGapTolerance',
                      'Real'),
                     ('relative_gap_tolerance', 'RelativeGapTolerance',
                      'Real'),
                     ('small_weight_tolerance', 'SmallWeightTolerance',
                      'Real'),
                     ('corner_tolerance', 'CornerTolerance', 'Real'),
                     ('halo_tolerance', 'HaloTolerance', 'Real'),
                     ('conservative_reciprocity_factor',
                      'ConservativeReciprocityFactor', 'Real'),
                     ('profile_preserving_reciprocity_factor',
                      'ProfilePreservingReciprocityFactor', 'Real'),
                     ('conservative_intensive', 'ConservativeIntensive',
                      'String'),
                     ('preserve_normal', 'PreserveNormal', 'String'),
                     ('conservation_fix_tolerance_volume',
                      'ConservationFixToleranceVolume', 'Real'),
                     ('rbf_option', 'RBFOption', 'String'),
                     ('rbf_shape_parameter', 'RBFShapeParameter', 'Real'),
                     ('rbf_linear_correction', 'RBFLinearCorrection',
                      'Boolean'),
    ...
    class solution_control(Group):
        ...
        class available_ports(Group):
            ...
            property_names_types = \
                [('option', 'Option', 'String'), ('range', 'Range', 'String')]
    ...
    class output_control(Group):
        ...
        property_names_types = \
            [('option', 'Option', 'String'),
             ('generate_csv_chart_output', 'GenerateCSVChartOutput',
              'Boolean'),
